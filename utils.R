# Supplementary functions used in GlobalZBio_01_Model.R
...
# k greater than 1 extends the wave, multiple cycles 
...
fPlotBiomassGLM <- function (mdl, Name) {
  ...
  #Thetao plot
  if(grepl("Thetao", Terms, fixed = TRUE)) {
    visreg(mdl, "Thetao", scale = "response", 
           xlab = "Thetao (ºC)", ylab = expression("Biomass"))}
